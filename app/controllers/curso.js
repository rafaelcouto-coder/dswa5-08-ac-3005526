...
var cursos = [
    { _id: 1, curso: 'Engenharia de Produção', coordenador: 'rafael.couto@ifsp.edu.br' },
    { _id: 2, curso: 'Tecnologia em Análise e Desenvolvimento de Sistemas', coordenador: 'lucas.annunziato@ifsp.edu.br' },
    { _id: 3, curso: 'Licenciatura em Letras Português/Inglês', coordenador: 'daniel.formgoni@ifsp.edu.br' },
    { _id: 4, curso: 'Tecnologia em Gestão Pública', coordenador: 'bianca.faria@ifsp.edu.br' }
]
